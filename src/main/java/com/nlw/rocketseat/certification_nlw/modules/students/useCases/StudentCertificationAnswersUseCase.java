...
import com.nlw.rocketseat.certification_nlw.modules.questions.repositories.QuestionRepository;
import com.nlw.rocketseat.certification_nlw.modules.students.dto.StudentCertificationAnswerDTO;
import com.nlw.rocketseat.certification_nlw.modules.students.dto.VerifyHasCertificationDTO;
import com.nlw.rocketseat.certification_nlw.modules.students.entities.AnswersCertificationsEntity;
import com.nlw.rocketseat.certification_nlw.modules.students.entities.CertificationStudentEntity;
import com.nlw.rocketseat.certification_nlw.modules.students.entities.StudentEntity;
import com.nlw.rocketseat.certification_nlw.modules.students.repositories.CertificationStudentRepository;
import com.nlw.rocketseat.certification_nlw.modules.students.repositories.StudentRepository;
  ...
  public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception {
    ...
    dto.getQuestionsAnswers()
      .stream().forEach(questionAnswer -> {
        ...
        var findCorrectAlternative = question.getAlternativesEntity().stream()
      ...
      answersCertifications.stream().forEach(answerCertification -> {
        ...
        answerCertification.setStudentID(student_id);
      });
